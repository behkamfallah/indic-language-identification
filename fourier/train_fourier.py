"""Standalone Fourier-domain training entrypoint for Task 2."""
...
try:
    from .config_utils_fourier import get_nested, load_yaml, merge_dicts, parse_overrides, save_json
    from .dataset_utils_fourier import prepare_encoded_datasets_fourier
    from .model_utils_fourier import build_fourier_audio_classification_model, count_parameters
    from .tracking_utils_fourier import setup_hf, setup_wandb
    from .trainer_utils_fourier import (
        AudioDataCollatorFourier,
        build_fourier_trainer,
    ...
    from model_utils_fourier import build_fourier_audio_classification_model, count_parameters
    from tracking_utils_fourier import setup_hf, setup_wandb
    from trainer_utils_fourier import AudioDataCollatorFourier, build_fourier_trainer, build_training_arguments


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Fourier-domain training for Indic language identification.")
...
def main() -> None:
    ...
    print(f"Running Fourier experiment {run_id}:")
    ...
    prepared_data = prepare_encoded_datasets_fourier(
        config=config,
        feature_extractor=feature_extractor,
        seed=seed,
    )

    model = build_fourier_audio_classification_model(
        config=config,
